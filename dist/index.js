...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BoardDomain = __webpack_require__(160);
	
	var _BoardDomain2 = _interopRequireDefault(_BoardDomain);
	
	var _SnakeDomain = __webpack_require__(164);
	
	var _SnakeDomain2 = _interopRequireDefault(_SnakeDomain);
	
	var _TreatDomain = __webpack_require__(167);
	
	var _TreatDomain2 = _interopRequireDefault(_TreatDomain);
	
	var _RoundDomain = __webpack_require__(168);
	
	var _RoundDomain2 = _interopRequireDefault(_RoundDomain);
	
	var _BoardComponent = __webpack_require__(169);
	...
	di.boardSize = 20;
	di.RoundDomain = new _RoundDomain2.default(di);
	di.TreatDomain = new _TreatDomain2.default(di);
	di.SnakeDomain = new _SnakeDomain2.default(di);
	di.BoardDomain = new _BoardDomain2.default(di);
	
	var Board = (0, _BoardComponent2.default)(di);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _immview = __webpack_require__(162);
	...
	var BoardDomain = function (_Domain) {
	    _inherits(BoardDomain, _Domain);
	
	    function BoardDomain(_ref) {
	        var boardSize = _ref.boardSize;
	        var SnakeDomain = _ref.SnakeDomain;
	        var TreatDomain = _ref.TreatDomain;
	        var RoundDomain = _ref.RoundDomain;
	
	        _classCallCheck(this, BoardDomain);
	
	        var board = new _immview.View({
	            snake: SnakeDomain.view,
	            treat: TreatDomain.view
	        }, function (data) {
	
	            if (data.get('snake') && data.get('treat')) {
	                var head;
	
	                var _ret = function () {
	
	                    var emptyBoard = I.Map();
	
	                    var range = I.Range(0, boardSize).toList();
	                    range.forEach(function (x) {
	                        range.forEach(function (y) {
	                            emptyBoard = emptyBoard.set(I.Map({ x: x, y: y }), boardFieldTypes.EMPTY);
	                        });
	                    });
	
	                    var board = emptyBoard;
	
	                    data.get('snake').forEach(function (position) {
	                        board = board.set(position, boardFieldTypes.SNAKE);
	                    });
	
	                    var treat = data.get('treat');
	                    board = board.set(treat, boardFieldTypes.TREAT);
	
	                    /** board rules */
	
	                    head = data.get('snake').last();
	                     ...
	                     * player looses
	                     */
	                    if (data.get('snake').butLast().find(function (v) {
	                        return I.is(v, head);
	                    })) {
	                        RoundDomain.loose();
	                    }
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BoardDomain).call(this, board, {}));
	
	        _this.fieldTypes = boardFieldTypes;
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		if (( false ? 'undefined' : _typeof2(exports)) === 'object' && ( false ? 'undefined' : _typeof2(module)) === 'object') module.exports = factory(__webpack_require__(161));else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(161)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));else if ((typeof exports === 'undefined' ? 'undefined' : _typeof2(exports)) === 'object') exports["immview"] = factory(require("immutable"));else root["immview"] = factory(root["immutable"]);
		...
		return (/******/function (modules) {
			...
			/***/function (module, exports, __webpack_require__) {
				...
				}Object.defineProperty(exports, "__esModule", { value: !0 }), exports.Domain = exports.View = exports.Data = void 0;var _Domain = __webpack_require__(1),
				    _Domain2 = _interopRequireDefault(_Domain),
				    _Data = __webpack_require__(4),
				    _Data2 = _interopRequireDefault(_Data),
				    _View = __webpack_require__(7),
				    _View2 = _interopRequireDefault(_View);exports.Data = _Data2["default"], exports.View = _View2["default"], exports.Domain = _Domain2["default"];
			...
			/***/function (module, exports, __webpack_require__) {
				...
				}();Object.defineProperty(exports, "__esModule", { value: !0 });var _immutable = __webpack_require__(2),
				    I = _interopRequireWildcard(_immutable),
				    _Queue = __webpack_require__(3),
				    _Queue2 = _interopRequireDefault(_Queue),
				    noop = function noop() {},
				    Domain = function () {
					function e(t, i) {
						_classCallCheck(this, e), this.view = null, this.data = null, this._actionNames = null, this._claimView(t), this._claimActions(i);
					}return _createClass(e, [{ key: "_claimView", value: function value(e) {
							if (!e.isReactor) throw new Error("view is not inheriting Reactor type");this.view = e, e.isData && (this.data = e);
						} }, { key: "_claimActions", value: function value(e) {
							var t = this;this._actionNames = e ? Object.keys(e) : [], this._actionNames.forEach(function (i) {
								if (t[i]) throw new Error('"' + i + '" is reserved for Domain interface');t[i] = _Queue2["default"].createAction(e[i], t);
							});
						} }, { key: "subscribe", value: function value(e) {
							return this.view.subscribe(e);
						} }, { key: "destroy", value: function value() {
							var e = this;this.view.destroy(), this.view = null, this.data = null, _Queue2["default"].rejectContext(this), this._actionNames.forEach(function (t) {
								e[t] = noop;
							}), this._actionNames = null;
						} }, { key: "structure", get: function get() {
							return this.view && this.view.structure;
						} }, { key: "isDomain", get: function get() {
							return !0;
						} }]), e;
			...
			/***/function (module, exports, __webpack_require__) {
				...
				"use strict";
				function _interopRequireWildcard(e) {
					if (e && e.__esModule) return e;var r = {};if (null != e) for (var n in e) {
						Object.prototype.hasOwnProperty.call(e, n) && (r[n] = e[n]);
					}return r["default"] = e, r;
				}function createAction(e, r) {
					return function () {
						for (var n = arguments.length, u = Array(n), t = 0; n > t; t++) {
							u[t] = arguments[t];
						}appendToQueue(e, r, u), run();
					};
				}function appendToQueue(e, r, n) {
					queue = queue.add({ action: e, context: r, args: n });
				}function shiftFromQueue() {
					var e = queue.first();return queue = queue.rest(), e;
					...
					if (!isRunning) {
						for (isRunning = !0; queue.count() > 0;) {
							try {
								runFirst();
							} catch (e) {
								console.error("Immview.Queue run - Error occured while running running a function"), console.error(e.message);
							}
						}isRunning = !1;
					}
				}function runFirst() {
					var e = shiftFromQueue(),
					    r = e.context,
					    n = e.action,
					    u = e.args;n.apply(r, u);
				}Object.defineProperty(exports, "__esModule", { value: !0 });var _immutable = __webpack_require__(2),
				    I = _interopRequireWildcard(_immutable),
				    isRunning = !1,
				    queue = I.OrderedSet();exports["default"] = { createAction: createAction, rejectContext: rejectContext };
			...
			/***/function (module, exports, __webpack_require__) {
				...
				function _interopRequireDefault(e) {
					...
					if (!e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return !r || "object" != (typeof r === 'undefined' ? 'undefined' : _typeof2(r)) && "function" != typeof r ? e : r;
				}function _inherits(e, r) {
					if ("function" != typeof r && null !== r) throw new TypeError("Super expression must either be null or a function, not " + (typeof r === 'undefined' ? 'undefined' : _typeof2(r)));e.prototype = Object.create(r && r.prototype, { constructor: { value: e, enumerable: !1, writable: !0, configurable: !0 } }), r && (Object.setPrototypeOf ? Object.setPrototypeOf(e, r) : e.__proto__ = r);
				}var _createClass = function () {
					function e(e, r) {
				    ...
				    I = _interopRequireWildcard(_immutable),
				    _Reactor2 = __webpack_require__(5),
				    _Reactor3 = _interopRequireDefault(_Reactor2),
				    _require = __webpack_require__(6),
				    immutableWriteWrapper = _require.immutableWriteWrapper,
				    immutableReadWrapper = _require.immutableReadWrapper,
				    Data = function (e) {
					function r(e) {
						_classCallCheck(this, r);var t = _possibleConstructorReturn(this, Object.getPrototypeOf(r).call(this));return immutableReadWrapper(t), immutableWriteWrapper(t), t.digest(I.fromJS(e)), t;
					}return _inherits(r, e), _createClass(r, [{ key: "process", value: function value(e) {
							return e;
						} }, { key: "destroy", value: function value() {
							this.structure = null, this.reactors = null;
						} }, { key: "isData", get: function get() {
							return !0;
						} }]), r;
				}(_Reactor3["default"]);exports["default"] = Data;
			...
			/***/function (module, exports, __webpack_require__) {
				...
				function _interopRequireWildcard(e) {
				    ...
				    Reactor = function () {
					function e() {
						_classCallCheck(this, e), this.reactors = I.Set(), this.structure = void 0;
					}return _createClass(e, [{ key: "subscribe", value: function value(e) {
							var r = this;return this.reactors = this.reactors.add(e), e(this.structure), function () {
								r.reactors = r.reactors["delete"](e);
							};
						} }, { key: "process", value: function value() {
							throw new Error("abstract");
						} }, { key: "digest", value: function value(e) {
							var r = this.process(e);r !== this.structure && (this.structure = r, this.flush());
						} }, { key: "flush", value: function value() {
							var e = this;this.reactors.forEach(function (r) {
								return r(e.structure);
							});
						} }, { key: "destroy", value: function value() {
							throw new Error("abstract");
						} }, { key: "isReactor", get: function get() {
							return !0;
						} }]), e;
			...
			/***/function (module, exports, __webpack_require__) {
				...
				function _interopRequireDefault(e) {
					return e && e.__esModule ? e : { "default": e };
				}function immutableReadWrapper(e) {
					["equals", "hashCode", "get", "has", "includes", "first", "last", "getIn", "hasIn", "toJS", "toObject", "toArray", "toMap", "toOrderedMap", "toSet", "toOrderedSet", "toList", "toStack", "toSeq", "toKeyedSeq", "toIndexedSeq", "toSetSeq", "keys", "values", "entries", "keySeq", "valueSeq", "entrySeq", "map", "filter", "filterNot", "reverse", "sort", "sortBy", "groupBy", "forEach", "slice", "rest", "butLast", "skip", "skipLast", "skipWhile", "skipUntil", "take", "takeLast", "takeWhile", "takeUntil", "concat", "flatten", "flatMap", "reduce", "reduceRight", "every", "some", "join", "isEmpty", "count", "countBy", "find", "findLast", "findEntry", "findLastEntry", "max", "maxBy", "min", "minBy", "isSubset", "isSuperset"].forEach(function (t) {
						e[t] = function () {
							for (var r = arguments.length, a = Array(r), u = 0; r > u; u++) {
								a[u] = arguments[u];
							}return e.structure[t].apply(e.structure, a);
						};
					});
				}function immutableWriteWrapper(e) {
					["set", "delete", "update", "merge", "mergeDeep", "setIn", "deleteIn", "updateIn", "mergeIn", "mergeDeepIn", "add", "clear", "union", "intersect", "substract"].forEach(function (t) {
						e[t] = _Queue2["default"].createAction(function () {
							for (var r = arguments.length, a = Array(r), u = 0; r > u; u++) {
								a[u] = arguments[u];
							}e.digest(e.structure[t].apply(e.structure, a));
						});
					});
				}Object.defineProperty(exports, "__esModule", { value: !0 }), exports.immutableReadWrapper = exports.immutableWriteWrapper = void 0;var _Queue = __webpack_require__(3),
				    _Queue2 = _interopRequireDefault(_Queue);exports.immutableWriteWrapper = immutableWriteWrapper, exports.immutableReadWrapper = immutableReadWrapper;
			...
			/***/function (module, exports, __webpack_require__) {
				...
				function _interopRequireDefault(e) {
				    ...
				    _Reactor2 = __webpack_require__(5),
				    _Reactor3 = _interopRequireDefault(_Reactor2),
				    _ImmutableWrapper = __webpack_require__(6),
				    View = function (e) {
					function t(e, r) {
						_classCallCheck(this, t);var n = _possibleConstructorReturn(this, Object.getPrototypeOf(t).call(this));return r && (n.process = r), (0, _ImmutableWrapper.immutableReadWrapper)(n), e && "object" === ("undefined" == typeof e ? "undefined" : _typeof(e)) && (e.isReactor || e.isDomain ? n.connectToView(e) : n.connectToViews(e)), n;
					}return _inherits(t, e), _createClass(t, [{ key: "connectToView", value: function value(e) {
							this.unsubs = [e.subscribe(this.digest.bind(this))];
						} }, { key: "connectToViews", value: function value(e) {
							var t = this;this.prestructure = I.Map(), this.unsubs = Object.keys(e).map(function (r) {
								var n = function n(e) {
									t.digest(t.prestructure = t.prestructure.set(r, e));
								};return e[r].subscribe(n);
							});
							...
							this.unsubs.forEach(function (e) {
								return e();
							}), this.unsubs = null, this.structure = null, this.prestructure = null, this.reactors = null;
						} }, { key: "isView", get: function get() {
							return !0;
						} }]), t;
				}(_Reactor3["default"]);exports["default"] = View;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DirectionDomain = __webpack_require__(165);
	
	var _DirectionDomain2 = _interopRequireDefault(_DirectionDomain);
	...
	var SnakePositions = function (_View) {
	    _inherits(SnakePositions, _View);
	
	    function SnakePositions(_ref) {
	        var _this;
	
	        var boardSize = _ref.boardSize;
	
	        _classCallCheck(this, SnakePositions);
	
	        var snakeStartPosition = I.Map({
	            x: Math.round(boardSize / 2),
	            y: Math.round(boardSize / 2)
	        });
	
	        return _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SnakePositions).call(this, _DirectionDomain2.default, function (data) {
	            if (_this && _this.structure) {
	                var positions = _this.structure;
	...
	var SnakeBody = function (_View2) {
	    _inherits(SnakeBody, _View2);
	
	    function SnakeBody(_ref2) {
	        var RoundDomain = _ref2.RoundDomain;
	        var snakePositions = _ref2.snakePositions;
	
	        _classCallCheck(this, SnakeBody);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(SnakeBody).call(this, {
	            RoundDomain: RoundDomain,
	            snakePositions: snakePositions
	        }, function (data) {
	            if (data && data.get('RoundDomain') && data.get('snakePositions')) {
	...
	var Snake = function (_Domain) {
	    _inherits(Snake, _Domain);
	
	    function Snake(_ref3) {
	        var boardSize = _ref3.boardSize;
	        var RoundDomain = _ref3.RoundDomain;
	
	        _classCallCheck(this, Snake);
	
	        var snakePositions = new SnakePositions({ boardSize: boardSize });
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Snake).call(this,
	        /** structure */
	        new SnakeBody({ RoundDomain: RoundDomain, snakePositions: snakePositions }),
	        /** actions */
	        {
	            grow: function grow() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TickerDomain = __webpack_require__(166);
	
	var _TickerDomain2 = _interopRequireDefault(_TickerDomain);
	...
	var directionDictionary = (_directionDictionary = {}, _defineProperty(_directionDictionary, keys.UP, directionVectors.UP), _defineProperty(_directionDictionary, keys.DOWN, directionVectors.DOWN), _defineProperty(_directionDictionary, keys.LEFT, directionVectors.LEFT), _defineProperty(_directionDictionary, keys.RIGHT, directionVectors.RIGHT), _defineProperty(_directionDictionary, keys.SPACE, directionVectors.NONE), _directionDictionary);
	
	var Direction = function (_Domain) {
	    _inherits(Direction, _Domain);
	
	    function Direction() {
	        _classCallCheck(this, Direction);
	
	        var direction = directionVectors.NONE;
	
	        window.addEventListener('keydown', function (event) {
	            var newDirection = directionDictionary[event.keyCode];
	        ...
	        var directionData = new _immview.View(_TickerDomain2.default, function (data) {
	            //if there is and would be tick with NONE direction, do not tick
	            if (directionData && directionData.structure &&
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ticker = function (_Domain) {
	    _inherits(Ticker, _Domain);
	
	    function Ticker() {
	        var tempo = arguments.length <= 0 || arguments[0] === undefined ? 200 : arguments[0];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TreatDomain = function (_Domain) {
	    _inherits(TreatDomain, _Domain);
	
	    function TreatDomain(_ref) {
	        var boardSize = _ref.boardSize;
	
	        _classCallCheck(this, TreatDomain);
	
	        var treatData = new _immview.Data(I.Map({ x: randomInt(boardSize), y: randomInt(boardSize) }));
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(TreatDomain).call(this,
	        /** structure */
	        treatData,
	        /** actions */
	        {
	            spawn: function spawn() {
	                ...
	                var _ref2$x = _ref2.x;
	                var x = _ref2$x === undefined ? randomInt(boardSize) : _ref2$x;
	                var _ref2$y = _ref2.y;
	                var y = _ref2$y === undefined ? randomInt(boardSize) : _ref2$y;
	
	                treatData.update(function () {
	                    return I.Map({ x: x, y: y });
	                });
	            }
	        }));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RoundDomain = function (_Domain) {
	    _inherits(RoundDomain, _Domain);
	
	    function RoundDomain() {
	        _classCallCheck(this, RoundDomain);
	
	        var roundData = new _immview.Data(I.Map({
	            points: 0
	        }));
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(RoundDomain).call(this,
	        /** structure */
	        roundData,
	        /** actions */
	        {
	            increase: function increase() {
	                roundData.update(function (data) {
	                    return data.set('points', data.get('points') + 1);
	                });
	            },
	            loose: function loose() {
	                roundData.update(function (data) {
	                    return data.set('points', 0);
	                });
	            }
	        }));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
	    var BoardDomain = _ref.BoardDomain;
	
	
	    var Cell = (0, _CellComponent2.default)({ BoardDomain: BoardDomain });
	    ...
	    var BoardComponent = function (_React$Component) {
	        ...
	        function BoardComponent() {
	            ...
	            return _possibleConstructorReturn(this, Object.getPrototypeOf(BoardComponent).apply(this, arguments));
	        }
	    ...
	    return (0, _immviewReactConnect2.default)(BoardComponent, BoardDomain, function (board) {
	        var rows = I.List();
	        board.forEach(function (value, position) {
	            var x = position.get('x');
	            var y = position.get('y');
	
	            var row = rows.get(y) || I.List();
	            rows = rows.set(y, row.set(x, value));
	        });
	        return I.Map({ rows: rows });
	    });
	};
	...
	var _immviewReactConnect = __webpack_require__(170);

	var _immviewReactConnect2 = _interopRequireDefault(_immviewReactConnect);

	var _CellComponent = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		if (( false ? 'undefined' : _typeof(exports)) === 'object' && ( false ? 'undefined' : _typeof(module)) === 'object') module.exports = factory(__webpack_require__(1), __webpack_require__(162), __webpack_require__(161));else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(162), __webpack_require__(161)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));else if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object') exports["immview-react-connect"] = factory(require("react"), require("immview"), require("immutable"));else root["immview-react-connect"] = factory(root["react"], root["immview"], root["immutable"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
	    ...
	    var cellFuncStyles = (_cellFuncStyles = {}, _defineProperty(_cellFuncStyles, BoardDomain.fieldTypes.EMPTY, {
	        background: '#787964'
	    }), _defineProperty(_cellFuncStyles, BoardDomain.fieldTypes.SNAKE, {
	        background: 'black'
	    }), _defineProperty(_cellFuncStyles, BoardDomain.fieldTypes.TREAT, {
	        background: '#787964',
	    ...
	    var CellComponent = function (_React$Component) {
	        _inherits(CellComponent, _React$Component);
	
	        function CellComponent() {
	            _classCallCheck(this, CellComponent);
	
	            return _possibleConstructorReturn(this, Object.getPrototypeOf(CellComponent).apply(this, arguments));
	        }
	
	        _createClass(CellComponent, [{
	            key: 'render',
	            value: function render() {
	                var thisCellStyle = _extends({}, cellStyle, cellFuncStyles[this.props.cell]);
	                return _react2.default.createElement('div', { style: thisCellStyle });
	            }
	        }]);
